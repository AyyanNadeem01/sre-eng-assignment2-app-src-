        ...
        while (true) {
            ...
            if (i2 < 5) {
                ...
                if (i3 >= 0) {
                    ...
                    sb.append(str);
                    sb.append(" (");
                    sb.append(AnonymousClass000.A03(str).exists() ? "exists" : "does not exist");
                    sb.append(")");
                }
                i2++;
            }
    ...
    */
    public final synchronized boolean A01(java.lang.String r6) {
        ...
        L3a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C02410Ay.A01(java.lang.String):boolean");
    }
}
