...
public class SuperpackUnloader {
    ...
    static {
        ...
        strArr[15] = "libmem_alloc_marker.so";
        strArr[16] = "libfbunwindstack.so";
        strArr[17] = "liblive-query-jni.so";
        AnonymousClass000.A0F("libcoldstart.so", "libaospbugfixmerged.so", "libsigquit.so", "libreliabilitymerged.so", strArr);
        strArr[22] = "libfb_mboost.so";
    ...
    public static boolean isStartupLibrary(C0A9 c0a9) {
        return COLD_START_LIBS.contains(c0a9.A01) && c0a9.A00 < STARTUP_LOAD_TIME_THRESHOLD;
    }

    public static void registerLibraryForUnloading(String str) throws IOException {
        if (!str.endsWith(".so")) {
            ...
            if (sStartTime == 0) {
                synchronized (SuperpackUnloader.class) {
                    if (sStartTime == 0) {
                        sStartTime = jElapsedRealtime;
                    }
                }
            }
            long j = jElapsedRealtime - sStartTime;
            long j2 = j >= 0 ? j : 0L;
            try {
                str = AnonymousClass000.A03(str).getCanonicalPath();
            } catch (IOException e) {
                AnonymousClass037.A02(TAG, "Failed to get canonical path for library", e);
            }
            List list = sInMemoryLibraries;
            C0A9 c0a9 = new C0A9();
            c0a9.A01 = libraryName;
            c0a9.A02 = str;
            c0a9.A00 = j2;
            list.add(c0a9);
        }
    ...
    */
    public void onTrim(X.C08K r8) {
        /*
            ...
            r4.<init>(r1)
            java.util.ArrayList r3 = X.AnonymousClass000.A0B()
            X.08K r0 = X.C08K.A02
            if (r8 == r0) goto L36
            int r2 = r4.size()
        L21:
        ...
        L42:
            ...
            X.0A9 r0 = (X.C0A9) r0     // Catch: java.lang.RuntimeException -> L54 java.lang.Throwable -> L68
        ...
        L59:
            ...
            X.C018108b.A0A(r1, r0, r4)     // Catch: java.lang.Throwable -> L68
        L60:
        ...
        L73:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.superpack.SuperpackUnloader.onTrim(X.08K):void");
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    /* JADX WARN: Removed duplicated region for block: B:21:0x0009 A[RETURN] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static boolean shouldUnloadLibrary(X.C08K r5, X.C0A9 r6) {
        /*
            int r1 = r5.ordinal()
            r5 = 0
            r0 = 1
        ...
        L2d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.superpack.SuperpackUnloader.shouldUnloadLibrary(X.08K, X.0A9):boolean");
    }
}
