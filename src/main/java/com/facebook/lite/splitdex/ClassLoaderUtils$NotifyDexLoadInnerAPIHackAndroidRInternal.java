...
public class ClassLoaderUtils$NotifyDexLoadInnerAPIHackAndroidRInternal {
    public static void apply(Context context, ClassLoader classLoader, String str) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        try {
            ...
            map.put(str, getClassLoaderContext(context, classLoader, null, false));
            declaredMethod.invoke(obj, context.getPackageName(), map, VMRuntime.getRuntime().vmInstructionSet());
        } catch (Exception e) {
            Log.e("NotifyDexLoad", "Failed to get method", e);
        }
    }

    public static String getClassLoaderContext(Context context, ClassLoader classLoader, String str, boolean z) throws NoSuchFieldException, ClassNotFoundException, SecurityException {
        String name;
        try {
            ...
            for (ClassLoader parent2 = classLoader; parent2 != null && parent2 != parent; parent2 = parent2.getParent()) {
                if (!(parent2 instanceof PathClassLoader)) {
                    StringBuilder sb2 = new StringBuilder();
                    sb2.append("Unable to compute class loader context, unknown classloader: ");
                    sb2.append(parent2.toString());
                ...
                Object[] objArr = (Object[]) declaredField2.get(declaredField.get(parent2));
                for (int i = 0; i < objArr.length; i++) {
                    ...
                    if (name != null) {
                        if (parent2.equals(classLoader) && name.equals(str)) {
                            break;
                        }
                        if (!z2 && i != 0) {
                            sb.append(":");
                ...
                if (!z2) {
                    sb.append("]");
                    sb.append(getSharedLibraryContext(context, parent2));
                }
                if (!z) {
                    break;
                }
    ...
    public static ClassLoader[] getSLCL(ClassLoader classLoader) throws NoSuchFieldException, SecurityException {
    ...
    public static String getSharedLibraryContext(Context context, ClassLoader classLoader) throws NoSuchFieldException, ClassNotFoundException, SecurityException {
        ClassLoader[] slcl;
