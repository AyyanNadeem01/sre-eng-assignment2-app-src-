...
public class ClassCoverageLogger {
    ...
    public static volatile boolean ENABLED = "true".equals(C07O.A02(ENABLE_CLASS_COVERAGE));
    public static final String THROW_ON_CLASS_LOAD = "fb.throw_on_class_load";
    public static volatile String THROW_ON_LOADED = C07O.A02(THROW_ON_CLASS_LOAD);
